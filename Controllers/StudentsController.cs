...
namespace StudentCore.Controllers
{
    public class StudentsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Student_Code,Name,City,Branch,DOB,Gender,Statuts,Created_By,Created_Date,Modified_By,Modified_Date")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
